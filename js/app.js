...
document.addEventListener("DOMContentLoaded", function () {
  const options = {
    strings: ['Thanh Do', 'Hai Son', 'Huu Thang', 'Duc Thanh'],
    typeSpeed: 150,
    backSpeed: 50,
    backDelay: 3000,
    loop: true
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const multiTextElement = document.querySelector('.multi-textHS');
  let currentTextIndex = 0;
  let currentText = '';
  let isDeleting = false;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const multiTextElement = document.querySelector('.multi-textVT');
  let currentTextIndex = 0;
  let currentText = '';
  let isDeleting = false;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const multiTextElement = document.querySelector('.multi-textDT');
  let currentTextIndex = 0;
  let currentText = '';
  let isDeleting = false;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const multiTextElement = document.querySelector('.multi-text1');
  let currentTextIndex = 0;
  let currentText = '';
  let isDeleting = false;
